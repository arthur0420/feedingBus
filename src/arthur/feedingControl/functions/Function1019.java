...
public class Function1019 extends BaseFunction{
	static Logger log = Logger.getLogger(Function1019.class);
	@Override
	public Result execute() {
		
		String username = getStrParameter("username");
		String nickname = getStrParameter("nickname");
		String remark = getStrParameter("remark");
		String phone = getStrParameter("phone");
		String role = getStrParameter("role");
		
		Result result = new Result();
		
		UserService us = new UserServiceImp();
		us.addUser(username, nickname, remark, phone, role);
