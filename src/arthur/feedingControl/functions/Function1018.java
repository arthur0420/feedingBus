...
public class Function1018 extends BaseFunction{
	static Logger log = Logger.getLogger(Function1018.class);
	@Override
	public Result execute() {
		Result result = new Result();
		
		UserService us = new UserServiceImp();
		List<HashMap> queryUserList = us.queryUserList();
		result.setData(queryUserList);
